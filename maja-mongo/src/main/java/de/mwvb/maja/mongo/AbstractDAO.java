...
public abstract class AbstractDAO<E> {
	 ...
	 * @return CRC of str as 6 character long String (using base 36 that means used characters are 0-9 and a-z)
	 */
	...
	/**
	 * Throws RuntimeException if id is not a 6 character long String using characters 0-9 and a-z.
	 * @param id
	 */
